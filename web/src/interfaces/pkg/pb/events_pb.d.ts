...
export class HttpLogEvent extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: HttpLogEvent): HttpLogEvent.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: HttpLogEvent, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): HttpLogEvent;
  static deserializeBinaryFromReader(message: HttpLogEvent, reader: jspb.BinaryReader): HttpLogEvent;
}
